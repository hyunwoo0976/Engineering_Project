...
module FMUL_core #(parameter W=32)(
    ...
    Pipe_reg_1clk #(.W(1)) reg_SIGN_s5_s6(.clk(clk), .reset(reset), .D(s5_SIGN), .Q(s6_SIGN));
    ...
    Pipe_reg_1clk #(.W(8)) reg4_EXPO_s4_s5(.clk(clk), .reset(reset), .D(s4_EXPO), .Q(s5_EXPO));
    Pipe_reg_1clk #(.W(8)) reg5_EXPO_s5_s6(.clk(clk), .reset(reset), .D(s5_EXPO), .Q(s6_EXPO));
    
    Pipe_reg_1clk #(.W(1)) reg4_OF_s4_s5(.clk(clk), .reset(reset), .D(s4_OF), .Q(s5_OF));
    Pipe_reg_1clk #(.W(1)) reg4_UF_s4_s5(.clk(clk), .reset(reset), .D(s4_UF), .Q(s5_UF));

    Pipe_reg_1clk #(.W(1)) reg5_OF_s5_s6(.clk(clk), .reset(reset), .D(s5_OF), .Q(s6_OF));
    Pipe_reg_1clk #(.W(1)) reg5_UF_s5_s6(.clk(clk), .reset(reset), .D(s5_UF), .Q(s6_UF));
    ...
    Pipe_reg_1clk #(.W(48)) reg2_FRAC_mul_s2_s3 (.clk(clk), .reset(reset), .D(s2_FRAC_mul), .Q(s3_FRAC_mul));
    Pipe_reg_1clk #(.W(48)) reg3_FRAC_mul_s3_s4 (.clk(clk), .reset(reset), .D(s3_FRAC_mul), .Q(s4_FRAC_mul));
    ...
    Pipe_reg_1clk #(.W(1)) reg4_count_s3_s4(.clk(clk), .reset(reset), .D(s4_count), .Q(s5_count));
    Pipe_reg_1clk #(.W(1)) reg4_round_carry_s3_s4(.clk(clk), .reset(reset), .D(s4_round_carry), .Q(s5_round_carry));
    
    Pipe_reg_1clk #(.W(23)) reg4_FRAC_s4_s5(.clk(clk), .reset(reset), .D(s4_FRAC), .Q(s5_FRAC));
    Pipe_reg_1clk #(.W(23)) reg5_FRAC_s5_s6(.clk(clk), .reset(reset), .D(s5_FRAC), .Q(s6_FRAC));
