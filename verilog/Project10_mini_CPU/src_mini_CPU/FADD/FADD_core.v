...
//===================================================================================================================================
    ...
    barrel_shifter #(.W(48))s2_u_FRAC_shifter1_A(
    ...
    barrel_shifter #(.W(48))s2_u_FRAC_shifter1_B(
        .direction(s2_EXPO_direction),
        .count(s2_EXPO_count),
    ...
    Mode_Detector s2_mode_dector(
        .sign_A(s2_SIGN_A),
        .sign_B(s2_SIGN_B),
        .mode(s2_op),
        .eff_sub(s2_eff_sub)
    );
    Cond_Inverter #(.W(48))s2_u_cond_inverter_AB(
        .eff_sub(s2_eff_sub),
        .FRAC_B(s2_FRAC_shifted_B),
        .FRAC_cla_B(s2_FRAC_cond_B)
    );
    Cond_Inverter #(.W(48))s2_u_cond_inverter_BA(
        .eff_sub(s2_eff_sub),
...
// ======================================[stage 3]====================================================
    ...
    Magnitude_Restoration #(.W(48)) s3_u_magnitude_restoration(
        .Sum_1(s3_FRAC_Sum1),
...
// ======================================[stage 5]====================================================
    ...
    barrel_shifter #(.W(49)) s5_u_FRAC_barrel_shifter(
...
//===================================================================================================================================
// ======================================[stage 6]====================================================
    Exception_Handler_ADD s6_u_FADD_exception_handler(
        .SIGN(s6_final_SIGN),
        .EXPO(s6_final_EXPO),
        .FRAC(s6_final_FRAC),
        .overflow_flag(s6_OF),
